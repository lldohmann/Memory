...
;--------------------------------------------------------
	...
	C$CoreGameLoop.c$20$0_0$112	= .
	.globl	C$CoreGameLoop.c$20$0_0$112
...
_set_camera::
	add	sp, #-3
	C$CoreGameLoop.c$23$1_0$112	= .
	.globl	C$CoreGameLoop.c$23$1_0$112
;src\CoreGameLoop.c:23: SCY_REG = camera_y_pixels; SCX_REG = camera_x_pixels;
	ld	a, (#_camera_y_pixels)
	ldh	(_SCY_REG + 0), a
	ld	a, (#_camera_x_pixels)
	ldh	(_SCX_REG + 0), a
	C$CoreGameLoop.c$25$1_0$112	= .
	.globl	C$CoreGameLoop.c$25$1_0$112
;src\CoreGameLoop.c:25: map_pos_y_tiles = (uint8_t)(camera_y_pixels >> 3u);
	...
	ld	(hl), c
	C$CoreGameLoop.c$30$1_0$112	= .
	.globl	C$CoreGameLoop.c$30$1_0$112
;src\CoreGameLoop.c:30: set_bkg_based_submap(map_pos_x_tiles, map_pos_y_tiles, MIN(21u, HomeWidth-map_pos_x_tiles), 1, Home, HomeWidth, 128);
	ld	c, (hl)
	C$CoreGameLoop.c$26$1_0$112	= .
	.globl	C$CoreGameLoop.c$26$1_0$112
...
;src\CoreGameLoop.c:30: set_bkg_based_submap(map_pos_x_tiles, map_pos_y_tiles, MIN(21u, HomeWidth-map_pos_x_tiles), 1, Home, HomeWidth, 128);
	...
	rla
	ld	b, a
	C$CoreGameLoop.c$28$2_0$113	= .
	.globl	C$CoreGameLoop.c$28$2_0$113
...
;C:/gbdk/include/gb/gb.h:1150: _submap_tile_offset = 0;
	ld	hl, #__submap_tile_offset
	ld	(hl), #0x00
	C$CoreGameLoop.c$30$2_0$113	= .
	.globl	C$CoreGameLoop.c$30$2_0$113
;src\CoreGameLoop.c:30: set_bkg_based_submap(map_pos_x_tiles, map_pos_y_tiles, MIN(21u, HomeWidth-map_pos_x_tiles), 1, Home, HomeWidth, 128);
	jr	00105$
00104$:
	C$CoreGameLoop.c$34$3_0$115	= .
	.globl	C$CoreGameLoop.c$34$3_0$115
...
;C:/gbdk/include/gb/gb.h:1150: _submap_tile_offset = 0;
	ld	hl, #__submap_tile_offset
	ld	(hl), #0x00
	C$CoreGameLoop.c$36$2_0$113	= .
	.globl	C$CoreGameLoop.c$36$2_0$113
;src\CoreGameLoop.c:36: set_bkg_based_submap(map_pos_x_tiles, map_pos_y_tiles + 18u, MIN(21u, HomeWidth - map_pos_x_tiles), 1, Home, HomeWidth, 128);
00105$:
	C$CoreGameLoop.c$30$1_0$112	= .
	.globl	C$CoreGameLoop.c$30$1_0$112
;src\CoreGameLoop.c:30: set_bkg_based_submap(map_pos_x_tiles, map_pos_y_tiles, MIN(21u, HomeWidth-map_pos_x_tiles), 1, Home, HomeWidth, 128);
	ld	hl, #_map_pos_y_tiles
	ld	c, (hl)
	C$CoreGameLoop.c$39$2_0$113	= .
	.globl	C$CoreGameLoop.c$39$2_0$113
;src\CoreGameLoop.c:39: old_map_pos_y_tiles = map_pos_y_tiles;
	ld	hl, #_old_map_pos_y_tiles
	ld	(hl), c
00107$:
	C$CoreGameLoop.c$42$1_0$112	= .
	.globl	C$CoreGameLoop.c$42$1_0$112
;src\CoreGameLoop.c:42: map_pos_x_tiles = (uint8_t)(camera_x_pixels >> 3u);
	...
	ld	hl, #_map_pos_x_tiles
	ld	(hl), b
	C$CoreGameLoop.c$43$1_0$112	= .
	.globl	C$CoreGameLoop.c$43$1_0$112
;src\CoreGameLoop.c:43: if (map_pos_x_tiles != old_map_pos_x_tiles)
	ld	a, (hl)
	ld	hl, #_old_map_pos_x_tiles
	sub	a, (hl)
	jp	Z,00114$
	C$CoreGameLoop.c$47$1_0$112	= .
	.globl	C$CoreGameLoop.c$47$1_0$112
...
;	spillPairReg hl
	...
	rla
	ld	b, a
	C$CoreGameLoop.c$45$2_0$117	= .
	.globl	C$CoreGameLoop.c$45$2_0$117
...
;C:/gbdk/include/gb/gb.h:1150: _submap_tile_offset = 0;
	ld	hl, #__submap_tile_offset
	ld	(hl), #0x00
	C$CoreGameLoop.c$47$2_0$117	= .
	.globl	C$CoreGameLoop.c$47$2_0$117
;src\CoreGameLoop.c:47: set_bkg_based_submap(map_pos_x_tiles, map_pos_y_tiles, 1, MIN(19u, HomeHeight - map_pos_y_tiles), Home, HomeWidth, 128);
	jr	00112$
00111$:
	C$CoreGameLoop.c$51$3_0$119	= .
	.globl	C$CoreGameLoop.c$51$3_0$119
...
;C:/gbdk/include/gb/gb.h:1150: _submap_tile_offset = 0;
	ld	hl, #__submap_tile_offset
	ld	(hl), #0x00
	C$CoreGameLoop.c$53$2_0$117	= .
	.globl	C$CoreGameLoop.c$53$2_0$117
;src\CoreGameLoop.c:53: set_bkg_based_submap(map_pos_x_tiles + 20u, map_pos_y_tiles, 1, MIN(19u, HomeHeight - map_pos_y_tiles), Home, HomeWidth, 128);
00112$:
	C$CoreGameLoop.c$56$2_0$117	= .
	.globl	C$CoreGameLoop.c$56$2_0$117
;src\CoreGameLoop.c:56: old_map_pos_x_tiles = map_pos_x_tiles;
	ld	a, (#_map_pos_x_tiles)
	ld	(#_old_map_pos_x_tiles),a
00114$:
	C$CoreGameLoop.c$59$1_0$112	= .
	.globl	C$CoreGameLoop.c$59$1_0$112
;src\CoreGameLoop.c:59: old_camera_x_pixels = camera_x_pixels, old_camera_y_pixels = camera_y_pixels;
	...
	C$CoreGameLoop.c$60$1_0$112	= .
	.globl	C$CoreGameLoop.c$60$1_0$112
;src\CoreGameLoop.c:60: }
	...
	C$CoreGameLoop.c$64$1_0$133	= .
	.globl	C$CoreGameLoop.c$64$1_0$133
;src\CoreGameLoop.c:64: void CoreGameLoopSetup()
;	---------------------------------
; Function CoreGameLoopSetup
; ---------------------------------
_CoreGameLoopSetup::
	C$CoreGameLoop.c$67$1_0$133	= .
	.globl	C$CoreGameLoop.c$67$1_0$133
;src\CoreGameLoop.c:67: map_pos_x_tiles = map_pos_y_tiles = 0;
	ld	hl, #_map_pos_y_tiles
	ld	(hl), #0x00
	ld	hl, #_map_pos_x_tiles
	ld	(hl), #0x00
	C$CoreGameLoop.c$68$1_0$133	= .
	.globl	C$CoreGameLoop.c$68$1_0$133
;src\CoreGameLoop.c:68: old_map_pos_x_tiles = old_camera_y_pixels = 255; 
	ld	hl, #_old_map_pos_x_tiles
	ld	(hl), #0xff
	C$CoreGameLoop.c$69$1_0$133	= .
	.globl	C$CoreGameLoop.c$69$1_0$133
;src\CoreGameLoop.c:69: camera_x_pixels = 208;
	...
	xor	a, a
	ld	(hl), a
	C$CoreGameLoop.c$70$1_0$133	= .
	.globl	C$CoreGameLoop.c$70$1_0$133
;src\CoreGameLoop.c:70: camera_y_pixels = 96;
	...
	xor	a, a
	ld	(hl), a
	C$CoreGameLoop.c$71$1_0$133	= .
	.globl	C$CoreGameLoop.c$71$1_0$133
;src\CoreGameLoop.c:71: old_camera_x_pixels = camera_x_pixels; old_camera_y_pixels = camera_y_pixels;
	...
	xor	a, a
	ld	(hl), a
	C$CoreGameLoop.c$72$1_0$133	= .
	.globl	C$CoreGameLoop.c$72$1_0$133
;src\CoreGameLoop.c:72: redraw = FALSE;
	ld	hl, #_redraw
	ld	(hl), #0x00
	C$CoreGameLoop.c$74$1_0$133	= .
	.globl	C$CoreGameLoop.c$74$1_0$133
...
;C:/gbdk/include/gb/gb.h:1150: _submap_tile_offset = 0;
	ld	hl, #__submap_tile_offset
	ld	(hl), #0x00
	C$CoreGameLoop.c$76$1_0$133	= .
	.globl	C$CoreGameLoop.c$76$1_0$133
;src\CoreGameLoop.c:76: set_sprite_data(0, 128, Cast_Tiles);
	...
	add	sp, #4
	C$CoreGameLoop.c$77$1_0$133	= .
	.globl	C$CoreGameLoop.c$77$1_0$133
;src\CoreGameLoop.c:77: SPRITES_8x16;
	ldh	a, (_LCDC_REG + 0)
	or	a, #0x04
	ldh	(_LCDC_REG + 0), a
	C$CoreGameLoop.c$78$1_0$133	= .
	.globl	C$CoreGameLoop.c$78$1_0$133
;src\CoreGameLoop.c:78: SHOW_BKG;
	ldh	a, (_LCDC_REG + 0)
	or	a, #0x01
	ldh	(_LCDC_REG + 0), a
	C$CoreGameLoop.c$79$1_0$133	= .
	.globl	C$CoreGameLoop.c$79$1_0$133
;src\CoreGameLoop.c:79: SHOW_SPRITES;
	ldh	a, (_LCDC_REG + 0)
	or	a, #0x02
	ldh	(_LCDC_REG + 0), a
	C$CoreGameLoop.c$80$1_0$133	= .
	.globl	C$CoreGameLoop.c$80$1_0$133
;src\CoreGameLoop.c:80: set_camera();
	call	_set_camera
	C$CoreGameLoop.c$81$1_0$133	= .
	.globl	C$CoreGameLoop.c$81$1_0$133
;src\CoreGameLoop.c:81: fadeFromBlack(10);
	ld	a, #0x0a
	C$CoreGameLoop.c$82$1_0$133	= .
	.globl	C$CoreGameLoop.c$82$1_0$133
;src\CoreGameLoop.c:82: }
	...
	C$CoreGameLoop.c$86$1_0$137	= .
	.globl	C$CoreGameLoop.c$86$1_0$137
;src\CoreGameLoop.c:86: uint8_t CoreGameLoopUpdate()
;	---------------------------------
; Function CoreGameLoopUpdate
; ---------------------------------
_CoreGameLoopUpdate::
	C$CoreGameLoop.c$88$1_0$137	= .
	.globl	C$CoreGameLoop.c$88$1_0$137
;src\CoreGameLoop.c:88: joypadCurrent = joypad();
	call	_joypad
	ld	(#_joypadCurrent),a
	C$CoreGameLoop.c$89$1_0$137	= .
	.globl	C$CoreGameLoop.c$89$1_0$137
;src\CoreGameLoop.c:89: PlayerUpdate(&mouse);
	ld	de, #_mouse
	call	_PlayerUpdate
	C$CoreGameLoop.c$90$1_0$137	= .
	.globl	C$CoreGameLoop.c$90$1_0$137
;src\CoreGameLoop.c:90: DrawPlayer(&mouse);
	ld	de, #_mouse
	call	_DrawPlayer
	C$CoreGameLoop.c$91$1_0$137	= .
	.globl	C$CoreGameLoop.c$91$1_0$137
;src\CoreGameLoop.c:91: if (joypadCurrent & J_UP) {
	ld	hl, #_joypadCurrent
	ld	c, (hl)
	bit	2, c
	jr	Z, 00108$
	C$CoreGameLoop.c$92$2_0$138	= .
	.globl	C$CoreGameLoop.c$92$2_0$138
;src\CoreGameLoop.c:92: if (camera_y_pixels){
	ld	hl, #_camera_y_pixels + 1
	ld	a, (hl-)
	or	a, (hl)
	jr	Z, 00109$
	C$CoreGameLoop.c$93$3_0$139	= .
	.globl	C$CoreGameLoop.c$93$3_0$139
;src\CoreGameLoop.c:93: camera_y_pixels--;
	...
	ld	(hl+), a
	ld	(hl), d
	C$CoreGameLoop.c$94$3_0$139	= .
	.globl	C$CoreGameLoop.c$94$3_0$139
;src\CoreGameLoop.c:94: redraw = TRUE;
	ld	hl, #_redraw
	ld	(hl), #0x01
	jr	00109$
00108$:
	C$CoreGameLoop.c$96$1_0$137	= .
	.globl	C$CoreGameLoop.c$96$1_0$137
;src\CoreGameLoop.c:96: } else if (joypadCurrent & J_DOWN) {
	bit	3, c
	jr	Z, 00109$
	C$CoreGameLoop.c$97$2_0$140	= .
	.globl	C$CoreGameLoop.c$97$2_0$140
;src\CoreGameLoop.c:97: if (camera_y_pixels < HomeCameraMaxY)
	...
	sbc	a, #0x01
	jr	NC, 00109$
	C$CoreGameLoop.c$99$3_0$141	= .
	.globl	C$CoreGameLoop.c$99$3_0$141
;src\CoreGameLoop.c:99: camera_y_pixels++;
	...
	inc	(hl)
00186$:
	C$CoreGameLoop.c$100$3_0$141	= .
	.globl	C$CoreGameLoop.c$100$3_0$141
;src\CoreGameLoop.c:100: redraw = TRUE;
	ld	hl, #_redraw
	ld	(hl), #0x01
00109$:
	C$CoreGameLoop.c$104$1_0$137	= .
	.globl	C$CoreGameLoop.c$104$1_0$137
;src\CoreGameLoop.c:104: if (joypadCurrent & J_LEFT) {
	bit	1, c
	jr	Z, 00123$
	C$CoreGameLoop.c$105$2_0$142	= .
	.globl	C$CoreGameLoop.c$105$2_0$142
;src\CoreGameLoop.c:105: if (camera_x_pixels)
	ld	hl, #_camera_x_pixels + 1
	ld	a, (hl-)
	or	a, (hl)
	jr	Z, 00124$
	C$CoreGameLoop.c$107$3_0$143	= .
	.globl	C$CoreGameLoop.c$107$3_0$143
;src\CoreGameLoop.c:107: camera_x_pixels--;
	...
	ld	(hl+), a
	ld	(hl), d
	C$CoreGameLoop.c$108$3_0$143	= .
	.globl	C$CoreGameLoop.c$108$3_0$143
;src\CoreGameLoop.c:108: redraw = TRUE;
	ld	hl, #_redraw
	ld	(hl), #0x01
	jr	00124$
00123$:
	C$CoreGameLoop.c$110$1_0$137	= .
	.globl	C$CoreGameLoop.c$110$1_0$137
;src\CoreGameLoop.c:110: } else if (joypadCurrent & J_RIGHT) {
	bit	0, c
	jr	Z, 00120$
	C$CoreGameLoop.c$111$2_0$144	= .
	.globl	C$CoreGameLoop.c$111$2_0$144
;src\CoreGameLoop.c:111: if (camera_x_pixels < HomeCameraMaxX)
	...
	sbc	a, #0x00
	jr	NC, 00124$
	C$CoreGameLoop.c$113$3_0$145	= .
	.globl	C$CoreGameLoop.c$113$3_0$145
;src\CoreGameLoop.c:113: camera_x_pixels++;
	...
	inc	(hl)
00189$:
	C$CoreGameLoop.c$114$3_0$145	= .
	.globl	C$CoreGameLoop.c$114$3_0$145
;src\CoreGameLoop.c:114: redraw = TRUE;
	ld	hl, #_redraw
	ld	(hl), #0x01
	jr	00124$
00120$:
	C$CoreGameLoop.c$116$1_0$137	= .
	.globl	C$CoreGameLoop.c$116$1_0$137
;src\CoreGameLoop.c:116: } else if (joypadCurrent & J_SELECT) {
	bit	6, c
	jr	Z, 00117$
	C$CoreGameLoop.c$117$2_0$146	= .
	.globl	C$CoreGameLoop.c$117$2_0$146
;src\CoreGameLoop.c:117: fadeToBlack(10);
	ld	a, #0x0a
	call	_fadeToBlack
	C$CoreGameLoop.c$118$2_0$146	= .
	.globl	C$CoreGameLoop.c$118$2_0$146
;src\CoreGameLoop.c:118: return GAMETITLE;
	ld	a, #0x01
	ret
00117$:
	C$CoreGameLoop.c$120$1_0$137	= .
	.globl	C$CoreGameLoop.c$120$1_0$137
;src\CoreGameLoop.c:120: else if (joypadCurrent & J_A)
	bit	4, c
	jr	Z, 00124$
	C$CoreGameLoop.c$122$2_0$147	= .
	.globl	C$CoreGameLoop.c$122$2_0$147
;src\CoreGameLoop.c:122: set_sprite_data(0, 16, Skateboard_Tiles);
	...
	add	sp, #4
00124$:
	C$CoreGameLoop.c$124$1_0$137	= .
	.globl	C$CoreGameLoop.c$124$1_0$137
;src\CoreGameLoop.c:124: if (redraw)
	ld	a, (#_redraw)
	or	a, a
	jr	Z, 00126$
	C$CoreGameLoop.c$126$2_0$148	= .
	.globl	C$CoreGameLoop.c$126$2_0$148
;src\CoreGameLoop.c:126: wait_vbl_done();
	call	_wait_vbl_done
	C$CoreGameLoop.c$127$2_0$148	= .
	.globl	C$CoreGameLoop.c$127$2_0$148
;src\CoreGameLoop.c:127: set_camera();
	call	_set_camera
	C$CoreGameLoop.c$128$2_0$148	= .
	.globl	C$CoreGameLoop.c$128$2_0$148
;src\CoreGameLoop.c:128: redraw = FALSE;
	ld	hl, #_redraw
	ld	(hl), #0x00
00126$:
	C$CoreGameLoop.c$131$1_0$137	= .
	.globl	C$CoreGameLoop.c$131$1_0$137
;src\CoreGameLoop.c:131: return COREGAMELOOP;
	ld	a, #0x02
	C$CoreGameLoop.c$132$1_0$137	= .
	.globl	C$CoreGameLoop.c$132$1_0$137
