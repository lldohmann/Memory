...
;--------------------------------------------------------
	...
	C$player.c$9$0_0$141	= .
	.globl	C$player.c$9$0_0$141
...
_PlayerUpdate::
	ld	c, e
	ld	b, d
	C$player.c$12$1_0$141	= .
	.globl	C$player.c$12$1_0$141
;src\player.c:12: switch (ptr->playerState)
	...
	or	a, a
	ret	NZ
	C$player.c$15$2_0$142	= .
	.globl	C$player.c$15$2_0$142
;src\player.c:15: joypadPrevious = joypadCurrent;
	ld	a, (#_joypadCurrent)
	ld	(#_joypadPrevious),a
	C$player.c$16$2_0$142	= .
	.globl	C$player.c$16$2_0$142
;src\player.c:16: joypadCurrent = joypad();
	call	_joypad
	ld	hl, #_joypadCurrent
	ld	(hl), a
	C$player.c$15$1_0$141	= .
	.globl	C$player.c$15$1_0$141
;src\player.c:15: joypadPrevious = joypadCurrent;
	ld	e, (hl)
	C$player.c$20$1_0$141	= .
	.globl	C$player.c$20$1_0$141
;src\player.c:20: ptr->playerDirection = up;
	ld	hl, #0x0006
	add	hl, bc
	C$player.c$17$2_0$142	= .
	.globl	C$player.c$17$2_0$142
;src\player.c:17: if (joypadCurrent & J_UP)
	bit	2, e
	jr	Z, 00111$
	C$player.c$20$3_0$143	= .
	.globl	C$player.c$20$3_0$143
;src\player.c:20: ptr->playerDirection = up;
	ld	(hl), #0x01
	ret
00111$:
	C$player.c$22$2_0$142	= .
	.globl	C$player.c$22$2_0$142
;src\player.c:22: else if (joypadCurrent & J_DOWN)
	bit	3, e
	jr	Z, 00108$
	C$player.c$25$3_0$144	= .
	.globl	C$player.c$25$3_0$144
;src\player.c:25: ptr->playerDirection = down;
	ld	(hl), #0x00
	ret
00108$:
	C$player.c$27$2_0$142	= .
	.globl	C$player.c$27$2_0$142
;src\player.c:27: else if (joypadCurrent & J_RIGHT)
	bit	0, e
	jr	Z, 00105$
	C$player.c$30$3_0$145	= .
	.globl	C$player.c$30$3_0$145
;src\player.c:30: ptr->playerDirection = right;
	ld	(hl), #0x02
	ret
00105$:
	C$player.c$32$2_0$142	= .
	.globl	C$player.c$32$2_0$142
;src\player.c:32: else if (joypadCurrent & J_LEFT)
	bit	1, e
	ret	Z
	C$player.c$35$3_0$146	= .
	.globl	C$player.c$35$3_0$146
;src\player.c:35: ptr->playerDirection = left;
	ld	(hl), #0x03
	C$player.c$41$1_0$141	= .
	.globl	C$player.c$41$1_0$141
;src\player.c:41: }
	C$player.c$42$1_0$141	= .
	.globl	C$player.c$42$1_0$141
;src\player.c:42: }
	C$player.c$42$1_0$141	= .
	.globl	C$player.c$42$1_0$141
	XG$PlayerUpdate$0$0	= .
	...
	C$player.c$69$1_0$148	= .
	.globl	C$player.c$69$1_0$148
...
_DrawPlayer::
	add	sp, #-3
	C$player.c$73$1_0$148	= .
	.globl	C$player.c$73$1_0$148
;src\player.c:73: switch (ptr->playerDirection)
	...
	ldhl	sp,	#0
	ld	(hl), a
	C$player.c$76$1_0$148	= .
	.globl	C$player.c$76$1_0$148
...
;src\player.c:73: switch (ptr->playerDirection)
	...
	jr	Z, 00104$
	jp	00105$
	C$player.c$75$2_0$149	= .
	.globl	C$player.c$75$2_0$149
...
;C:/gbdk/include/gb/metasprites.h:142: return __move_metasprite(base_sprite, x, y);
	...
	add	sp, #3
	C$player.c$77$2_0$149	= .
	.globl	C$player.c$77$2_0$149
;src\player.c:77: break;
	jp	00112$
	C$player.c$78$2_0$149	= .
	.globl	C$player.c$78$2_0$149
...
;C:/gbdk/include/gb/metasprites.h:142: return __move_metasprite(base_sprite, x, y);
	...
	call	___move_metasprite
	add	sp, #3
	C$player.c$80$2_0$149	= .
	.globl	C$player.c$80$2_0$149
;src\player.c:80: break;
	jr	00112$
	C$player.c$81$2_0$149	= .
	.globl	C$player.c$81$2_0$149
...
;C:/gbdk/include/gb/metasprites.h:142: return __move_metasprite(base_sprite, x, y);
	...
	call	___move_metasprite
	add	sp, #3
	C$player.c$83$2_0$149	= .
	.globl	C$player.c$83$2_0$149
;src\player.c:83: break;
	jr	00112$
	C$player.c$84$2_0$149	= .
	.globl	C$player.c$84$2_0$149
...
;C:/gbdk/include/gb/metasprites.h:171: return __move_metasprite_vflip(base_sprite, x - 8, y);
	...
	add	sp, #3
	C$player.c$86$2_0$149	= .
	.globl	C$player.c$86$2_0$149
;src\player.c:86: break;
	jr	00112$
	C$player.c$87$2_0$149	= .
	.globl	C$player.c$87$2_0$149
...
;C:/gbdk/include/gb/metasprites.h:171: return __move_metasprite_vflip(base_sprite, x - 8, y);
	...
	call	___move_metasprite_vflip
	add	sp, #3
	C$player.c$90$1_0$148	= .
	.globl	C$player.c$90$1_0$148
;src\player.c:90: }
00112$:
	C$player.c$91$1_0$148	= .
	.globl	C$player.c$91$1_0$148
;src\player.c:91: }
	add	sp, #3
	C$player.c$91$1_0$148	= .
	.globl	C$player.c$91$1_0$148
