M:Battle
S:LBattle.set_2bpp_palette$palette$1_0$26({2}SI:U),B,1,-2
S:LBattle.set_1bpp_colors$bgcolor$1_0$29({1}SC:U),B,1,-1
S:LBattle.set_1bpp_colors$fgcolor$1_0$29({1}SC:U),B,1,-2
S:LBattle.set_bkg_based_tiles$w$1_0$35({1}SC:U),B,1,2
S:LBattle.set_bkg_based_tiles$h$1_0$35({1}SC:U),B,1,3
S:LBattle.set_bkg_based_tiles$tiles$1_0$35({2}DG,SC:U),B,1,4
S:LBattle.set_bkg_based_tiles$base_tile$1_0$35({1}SC:U),B,1,6
S:LBattle.set_bkg_based_tiles$y$1_0$35({1}SC:U),B,1,-1
S:LBattle.set_bkg_based_tiles$x$1_0$35({1}SC:U),B,1,-2
S:LBattle.set_bkg_based_submap$w$1_0$38({1}SC:U),B,1,2
S:LBattle.set_bkg_based_submap$h$1_0$38({1}SC:U),B,1,3
S:LBattle.set_bkg_based_submap$map$1_0$38({2}DG,SC:U),B,1,4
S:LBattle.set_bkg_based_submap$map_w$1_0$38({1}SC:U),B,1,6
S:LBattle.set_bkg_based_submap$base_tile$1_0$38({1}SC:U),B,1,7
S:LBattle.set_bkg_based_submap$y$1_0$38({1}SC:U),B,1,-1
S:LBattle.set_bkg_based_submap$x$1_0$38({1}SC:U),B,1,-2
S:LBattle.move_bkg$y$1_0$43({1}SC:U),B,1,-1
S:LBattle.move_bkg$x$1_0$43({1}SC:U),B,1,-2
S:LBattle.scroll_bkg$y$1_0$45({1}SC:S),B,1,-1
S:LBattle.scroll_bkg$x$1_0$45({1}SC:S),B,1,-2
S:LBattle.set_win_based_tiles$w$1_0$52({1}SC:U),B,1,2
S:LBattle.set_win_based_tiles$h$1_0$52({1}SC:U),B,1,3
S:LBattle.set_win_based_tiles$tiles$1_0$52({2}DG,SC:U),B,1,4
S:LBattle.set_win_based_tiles$base_tile$1_0$52({1}SC:U),B,1,6
S:LBattle.set_win_based_tiles$y$1_0$52({1}SC:U),B,1,-1
S:LBattle.set_win_based_tiles$x$1_0$52({1}SC:U),B,1,-2
S:LBattle.set_win_based_submap$w$1_0$55({1}SC:U),B,1,2
S:LBattle.set_win_based_submap$h$1_0$55({1}SC:U),B,1,3
S:LBattle.set_win_based_submap$map$1_0$55({2}DG,SC:U),B,1,4
S:LBattle.set_win_based_submap$map_w$1_0$55({1}SC:U),B,1,6
S:LBattle.set_win_based_submap$base_tile$1_0$55({1}SC:U),B,1,7
S:LBattle.set_win_based_submap$y$1_0$55({1}SC:U),B,1,-1
S:LBattle.set_win_based_submap$x$1_0$55({1}SC:U),B,1,-2
S:LBattle.move_win$y$1_0$60({1}SC:U),B,1,-1
S:LBattle.move_win$x$1_0$60({1}SC:U),B,1,-2
S:LBattle.scroll_win$y$1_0$62({1}SC:S),B,1,-1
S:LBattle.scroll_win$x$1_0$62({1}SC:S),B,1,-2
S:LBattle.SET_SHADOW_OAM_ADDRESS$address$1_0$67({2}DG,SV:S),B,1,-2
S:LBattle.set_sprite_tile$tile$1_0$69({1}SC:U),B,1,-1
S:LBattle.set_sprite_tile$nb$1_0$69({1}SC:U),B,1,-2
S:LBattle.get_sprite_tile$nb$1_0$71({1}SC:U),B,1,-1
S:LBattle.set_sprite_prop$prop$1_0$73({1}SC:U),B,1,-1
S:LBattle.set_sprite_prop$nb$1_0$73({1}SC:U),B,1,-2
S:LBattle.get_sprite_prop$nb$1_0$75({1}SC:U),B,1,-1
S:LBattle.move_sprite$y$1_0$77({1}SC:U),B,1,2
S:LBattle.move_sprite$x$1_0$77({1}SC:U),B,1,-1
S:LBattle.move_sprite$nb$1_0$77({1}SC:U),B,1,-2
S:LBattle.move_sprite$itm$1_0$78({2}DG,STOAM_item_t:S),B,1,-4
S:LBattle.scroll_sprite$y$1_0$79({1}SC:S),B,1,2
S:LBattle.scroll_sprite$x$1_0$79({1}SC:S),B,1,-1
S:LBattle.scroll_sprite$nb$1_0$79({1}SC:U),B,1,-2
S:LBattle.scroll_sprite$itm$1_0$80({2}DG,STOAM_item_t:S),B,1,-4
S:LBattle.hide_sprite$nb$1_0$81({1}SC:U),B,1,-1
S:LBattle.set_native_tile_data$data$1_0$89({2}DG,SC:U),B,1,2
S:LBattle.set_native_tile_data$nb_tiles$1_0$89({1}SC:U),B,1,-1
S:LBattle.set_native_tile_data$first_tile$1_0$89({2}SI:U),B,1,-3
F:G$BattleSetup$0_0$0({2}DF,SV:S),C,0,0,0,0,0
S:LBattle.BattleSetup$__1310720006$2_0$127({1}SC:U),R,0,0,[]
S:LBattle.BattleSetup$__1310720007$2_0$127({1}SC:U),R,0,0,[]
S:LBattle.BattleSetup$x$3_0$128({1}SC:U),R,0,0,[]
S:LBattle.BattleSetup$y$3_0$128({1}SC:U),R,0,0,[]
S:LBattle.BattleSetup$__1310720009$2_0$130({1}SC:S),R,0,0,[]
S:LBattle.BattleSetup$__1310720010$2_0$130({1}SC:S),R,0,0,[]
S:LBattle.BattleSetup$x$3_0$131({1}SC:S),R,0,0,[]
S:LBattle.BattleSetup$y$3_0$131({1}SC:S),R,0,0,[]
...
S:G$cursor_x$0_0$0({1}SC:U),E,0,0
S:G$cursor_y$0_0$0({1}SC:U),E,0,0
