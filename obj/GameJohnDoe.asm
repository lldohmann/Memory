...
;--------------------------------------------------------
	...
	C$GameJohnDoe.c$6$0_0$103	= .
	.globl	C$GameJohnDoe.c$6$0_0$103
;src\GameJohnDoe.c:6: void GameJohnDoeSetup()
;	---------------------------------
; Function GameJohnDoeSetup
; ---------------------------------
_GameJohnDoeSetup::
	C$GameJohnDoe.c$8$1_0$103	= .
	.globl	C$GameJohnDoe.c$8$1_0$103
...
;src\GameJohnDoe.c:12: }
	...
	C$GameJohnDoe.c$14$1_0$104	= .
	.globl	C$GameJohnDoe.c$14$1_0$104
...
;src\GameJohnDoe.c:17: joypadCurrent = joypad();
	...
	ld	(hl), a
	C$GameJohnDoe.c$19$1_0$104	= .
	.globl	C$GameJohnDoe.c$19$1_0$104
;src\GameJohnDoe.c:19: if (joypadCurrent & J_A)
	bit	4, (hl)
	jr	Z, 00102$
	C$GameJohnDoe.c$21$2_0$105	= .
	.globl	C$GameJohnDoe.c$21$2_0$105
...
;src\GameJohnDoe.c:22: fadeFromBlack(10);
	...
	call	_fadeFromBlack
00102$:
	C$GameJohnDoe.c$24$1_0$104	= .
	.globl	C$GameJohnDoe.c$24$1_0$104
;src\GameJohnDoe.c:24: if (joypadCurrent & J_B)
	ld	a, (#_joypadCurrent)
	bit	5, a
	jr	Z, 00104$
	C$GameJohnDoe.c$26$2_0$106	= .
	.globl	C$GameJohnDoe.c$26$2_0$106
...
;src\GameJohnDoe.c:27: fadeFromWhite(10);
	...
	call	_fadeFromWhite
00104$:
	C$GameJohnDoe.c$29$1_0$104	= .
	.globl	C$GameJohnDoe.c$29$1_0$104
;src\GameJohnDoe.c:29: if (joypadCurrent & J_SELECT)
	ld	a, (#_joypadCurrent)
	bit	6, a
	jr	Z, 00106$
	C$GameJohnDoe.c$31$2_0$107	= .
	.globl	C$GameJohnDoe.c$31$2_0$107
;src\GameJohnDoe.c:31: fadeToBlack(10);
	ld	a, #0x0a
	call	_fadeToBlack
	C$GameJohnDoe.c$32$2_0$107	= .
	.globl	C$GameJohnDoe.c$32$2_0$107
;src\GameJohnDoe.c:32: return GAMETITLE;
	ld	a, #0x01
	ret
00106$:
	C$GameJohnDoe.c$35$1_0$104	= .
	.globl	C$GameJohnDoe.c$35$1_0$104
;src\GameJohnDoe.c:35: return GAMEJOHNDOE;
	ld	a, #0x03
	C$GameJohnDoe.c$36$1_0$104	= .
	.globl	C$GameJohnDoe.c$36$1_0$104
